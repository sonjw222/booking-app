  ...
  return (
    <div className="app-shell settings-page-v2">
      ...
      <div className="legal-page">
        ...
        <table>
          <tbody>
            <tr><th>서비스명</th><td>우리동네 클래스</td></tr>
        ...
        <h2>통신판매중개자로서의 지위</h2>
        <p>
          우리동네 클래스는 회원과 센터(스튜디오·체육관 등 서비스 제공자) 간의 수업 예약 및
          수강권·상품 거래를 위한 플랫폼을 제공하는 통신판매중개자입니다. 각 수업·수강권·상품의
          내용, 이행, 하자 등에 대한 책임은 원칙적으로 이를 제공하는 센터에 있으며, 우리동네
          클래스는 「전자상거래 등에서의 소비자보호에 관한 법률」 제20조의2에 따라 거래 당사자가
          아님을 고지합니다.
        </p>
        <p>
          다만 회원의 결제 대금 수납은 우리동네 클래스가 결제대행사(토스페이먼츠)를 통해 직접
