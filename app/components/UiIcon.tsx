export type IconName =
  | "home" | "calendar" | "list" | "bell" | "user"
  | "search" | "ticket" | "users" | "message" | "palette"
  | "building" | "logout" | "receipt" | "shield" | "settings" | "sliders" | "location" | "clock" | "edit" | "megaphone" | "info" | "alert" | "check"
  | "pilates" | "skate" | "ballet" | "rhythm"
  | "yoga" | "boxing" | "swim" | "golf" | "grid" | "star";

export default function UiIcon({ name, size = 22 }: { name: IconName; size?: number }) {
  const common = { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.75, strokeLinecap: "round" as const, strokeLinejoin: "round" as const, "aria-hidden": true, focusable: false };
