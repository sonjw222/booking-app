...
**2026-08-02 후속 배치(P0-6/P1-12) 갱신**: 위 표의 "일정관리(휴무일/룸)" P0와 "운영설정" P1은
이후 별도 배치에서 수정 SQL·테스트까지 준비 완료됐습니다(아직 미실행). 최신 상태는
[TODO.md](./TODO.md)의 P0-6/P1-12 항목과 [24_P1_12_Settings_Audit.md](./24_P1_12_Settings_Audit.md)를
참고하세요 — 이 문서(23번)의 위 표는 2026-08-02 최초 감사 시점의 스냅샷으로 그대로 둡니다.
